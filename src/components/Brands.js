...
function Brands() {
    return (
        <
            ...
            <div className="bg-white shadow-xl shadow-[#9e1b1d] rounded-full w-60 h-60 flex justify-center items-center mx-5">
                <img className={"w-60"} src={dowarriors} alt="onisa logo"/>
            </div>
            <div className="bg-white shadow-xl shadow-[#8ec740] rounded-full w-60 h-60 flex justify-center items-center mx-5">
