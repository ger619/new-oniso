...
function Brands() {
  return (
    <div className="flex flex-col md:flex-row justify-center py-10">
      <div className="bg-white shadow-xl font-bold shadow-[#9e1b1d] rounded-full w-60 h-60 flex flex-col justify-center items-center mx-5 my-4 md:my-0">
        <p className="text-2xl">ONISA DESIGNS</p>
        <h1 className="text-2xl">COMPANY</h1>
        <h1 className="text-2xl">PROFILE</h1>
      </div>
      <div className="bg-white shadow-2xl shadow-[#9e1b1d] rounded-full w-60 h-60 flex justify-center items-center mx-5 my-4 md:my-0">
        <img className={"w-60"} src={dowarriors} alt="onisa logo" />
      </div>
      <div className="bg-white shadow-2xl shadow-[#8ec740] rounded-full w-60 h-60 flex justify-center items-center mx-5 my-4 md:my-0">
